...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Video', fields ['user']
        db.delete_foreign_key('videos_video', 'user_id')
        db.delete_unique('videos_video', ['user_id'])

    def backwards(self, orm):
        # Adding unique constraint on 'Video', fields ['user']
        db.create_unique('videos_video', ['user_id'])
