...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video2013.user_notified'
        db.add_column('videos_video2013', 'user_notified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video2013.user_notified'
        db.delete_column('videos_video2013', 'user_notified')
