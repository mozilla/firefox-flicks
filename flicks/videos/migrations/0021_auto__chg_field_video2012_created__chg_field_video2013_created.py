...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video2012.created'
        db.alter_column('videos_video2012', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Video2013.created'
        db.alter_column('videos_video2013', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Video2012.created'
        db.alter_column('videos_video2012', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Video2013.created'
        db.alter_column('videos_video2013', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
