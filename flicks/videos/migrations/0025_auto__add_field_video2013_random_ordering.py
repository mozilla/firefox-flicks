...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video2013.random_ordering'
        db.add_column('videos_video2013', 'random_ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video2013.random_ordering'
        db.delete_column('videos_video2013', 'random_ordering')
